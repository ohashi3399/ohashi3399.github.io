...
- 株式会社本田技術研究所にて、マルチモーダル運転支援の研究に従事
...
- 凸版印刷株式会社にて、光学文字認識と文法誤り訂正の研究に従事
- 前者は中世ギリシア語や現代日本語、くずし字など歴史的文書の翻刻の支援のために開発
- 後者は雑誌の人手による校正の負荷の軽減のために開発
- 2年間を通して、機械学習を用いた業務のための基礎知識を取得(論文調査、モデル設計、実装、学習、省メモリ化、技術レポート、新テーマ提案、特許作成等)

## 顔面の動画像解析に基づく光電容積脈波計測を用いたストレスレベルの推定（学生時）
...
# 学会
- 嗜好データセットを用いた応答文のアライメント - 日本語大規模言語モデルへの適用と安全性の評価 -言語処理学会第30回年次大会, 神戸, 日本, 2024

- Language-Based Risk Feedback System with Scene Recognition and Driver’s Gaze While Driving, SICE Annual Conference, Mitsuhashi Ryota, Tanaka Toshiyuki, Sakata Sachie, Yamada Kentaro, Yasui Yuji, Mie, Japan, 2023

- Dual-band video-based measurement for noncontact pulse rate estimation in infrared, CIE 2018 Conference on Smart Lighting, Taipei, Taiwan, 2018 

- Dual-Band Infrared Video-based Measurement Using Pulse Wave Maps to Analyze Heart Rate Variability, Ryota Mitsuhashi, Keiichiro Kagawa, Shoji Kawahito, Chawan Koopipat, and Norimichi Tsumura, Vancouver, BC, Canada, 2018

- Two-Band Infrared Video-based Measurement for Non-Contact Pulse Wave Detection on Face without Visible Lighting, Mitsuhashi Ryota, Genki Okada, Kouki Kurita, Keiichiro Kagawa, Shoji Kawahito, and Norimichi Tsumura, Twenty-fifth Color and Imaging Conference, Lillehammer, Norway, 2017
...
- The impact of direct preference optimazation - A usecase of Japanese LLM and safety evaluation -, The 30th Natural Language Processing, Kobe, Japan, 2024
